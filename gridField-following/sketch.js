...
function setup() {
  ...
  let fishSize = 0.005 * canvasSize;
  
  // Make a whole bunch of field with random maxspeed and maxforce values
  for (let i = 0; i < 120; i++) {
    vehicles.push(
      new Vehicle(
        random(width),
  ...
  // Add one fish who is resisting the flowfield
  rebel = new Vehicle(
    random(width),
    random(height),
    fishSize,
...
function draw() {
  ...
  // Tell all the fish to follow the flow field
